      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex justify-center gap-8 mb-8">
            ...
            <Link to="/team" className="text-lg font-medium text-gray-200 hover:text-white">
              Team
            </Link>
            <Link to="/news" className="text-lg font-medium text-gray-200 hover:text-white">
              News
            </Link>
          </div>
          ...
          <div className="flex justify-center gap-6 mb-8">
            <Link to="/moderators" className="text-base text-gray-300 hover:text-white">
              運営について
            </Link>
