...
const Features = () => {
  const features = [
    {
      icon: <Users className="h-8 w-8 stroke-[1.5] text-primary" />,
      title: "情熱的なコミュニティ",
      description: "同じ興味を持つファン同士でつながりましょう",
    },
    {
      icon: <Shield className="h-8 w-8 stroke-[1.5] text-primary" />,
      title: "安全な空間",
      description: "モデレーション付きの快適な環境で交流できます",
    },
    {
      icon: <Heart className="h-8 w-8 stroke-[1.5] text-primary" />,
      title: "推し中心",
      description: "推しについて自由に語り合える場所です",
    },
    {
      icon: <MessageCircle className="h-8 w-8 stroke-[1.5] text-primary" />,
      title: "活発な議論",
